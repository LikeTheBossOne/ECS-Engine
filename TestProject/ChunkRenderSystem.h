...
public:
	...
	void Update(float dt)
	{
		...
		glm::mat4 projection = glm::perspective(glm::radians(camera->_fov), 800.0f / 600.0f, 0.1f, 300.0f);
		...
		for (auto const& entity : _entities)
		{
			...
			RenderMesh(chunk.chunkMesh, glm::vec3(chunk.indexX * CHUNK_SIZE, 0, chunk.indexZ * CHUNK_SIZE), chunk.shader);
		}
	}
};